...
\begin{figure}[!ht]
    \centering
    \includegraphics[scale=0.3]{/home/souza/Documents/semestre_2019-2/calculo_numerico/trabalho_2/Graficos/newton/1.png}
    \caption{Gráfico da função um da lista cinco executada pelo método Newton.}
\end{figure}

\begin{figure}[!ht]
    \centering
    \includegraphics[scale=0.3]{/home/souza/Documents/semestre_2019-2/calculo_numerico/trabalho_2/Graficos/newton/2.png}
    \caption{Gráfico da função dois da lista cinco executada pelo método Newton.}
\end{figure}

\begin{figure}[!ht]
    \centering
    \includegraphics[scale=0.3]{/home/souza/Documents/semestre_2019-2/calculo_numerico/trabalho_2/Graficos/newton/3.png}
    \caption{Gráfico da função três da lista cinco executada pelo método Newton.}
\end{figure}

\begin{figure}[!ht]
    \centering
    \includegraphics[scale=0.3]{/home/souza/Documents/semestre_2019-2/calculo_numerico/trabalho_2/Graficos/newton/4.png}
    \caption{Gráfico da função um da lista cinco executada pelo método Newton.}
\end{figure}
